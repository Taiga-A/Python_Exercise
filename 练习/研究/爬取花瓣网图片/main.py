...
num     最大是页数
'''
def getPic(session,num,keyWord):
    for i in range(1,num+1):
        response = session.get("https://huaban.com/search/?q="+str(keyWord)+"&page="+str(i))
...
def main():
    ...
    num = input('请输入下载页数(*20个):')
    login(keyWord,int(num))
